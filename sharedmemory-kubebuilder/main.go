...
import (
	...
	"sharedmemory-kubebuilder/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "b9e65b22.github.com",
	})
	if err != nil {
	...
	if err = (&controllers.SharedmemoryReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("Sharedmemory"),
